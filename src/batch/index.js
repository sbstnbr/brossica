...
const lightItinerary = [
  [2.2431251, 48.9237226], [0.54338, 45.04037], [2.1734035, 41.3850639]
];
...
async function getRoutes(itinerary){
  ...
  for (let index = 0; index < itinerary.length-1; index++) {
    ...
    // fs.appendFile(__dirname+'/routes.json', JSON.stringify(response.data.routes[0].geometry), err => console.log(err));
  }
  console.log(result);
  return result;
}
